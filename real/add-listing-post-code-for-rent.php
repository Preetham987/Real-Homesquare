...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO user_project_table (
        ...
        Area, Bedroom, Bathrooms, Parking, Age_of_property, Facing_direction, Security_deposit, Minimum_lease_period, 
        ...
        '$area', '$bedrooms', '$bathrooms', '$parking', '$age_of_property', '$facing_direction', '$security_deposit', '$minimum_lease_period',
        '$property_details', '$Amenities', '$plans_and_brochure', 'Rent', '$username'
    )";
