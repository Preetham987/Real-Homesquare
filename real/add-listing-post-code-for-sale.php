...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO user_project_table (
        ...
        Area, Bedroom, Bathrooms, Parking, Age_of_property, Facing_direction,
        ...
        '$area', '$bedrooms', '$bathrooms', '$parking', '$age_of_property', '$facing_direction',
        '$property_details', '$Amenities', '$plans_and_brochure', 'Sale', '$username'
    )";
