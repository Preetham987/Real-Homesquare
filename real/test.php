...
<div class="content-section">
                            <div class="container  ">
                                <div class="section-title">
                                    <h4>Prominent developers in Bengaluru
                                    </h4>
                                    <h2>Featured Developers
                                    </h2>
                                </div>
                            </div>
                                                    ...
                                                    <div class="testimonilas-text">
                                                        <div class="testi-header">
                                                            <div class="row">
                                                                ...
                                                                <div class="testi-avatar"><img src="images/clients/sattva-logo.png" alt=""></div>
                                                            <h3>Sattva La Vita - Bangalore
                                                            </h3>
                                                            <p>2014 Year estd.</p>
                                                                </div>
                                                                <div class="col-md-4 col-12" >
                                                                <div class="right">7 Projects</div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="testimonilas-text-item">
                                                            <div class="testimonilas-text-item-wrap">
                                                                <p>"Sattva La Vita is a reputed name behind some of the prestigious and advanced facilities in Mysuru. Since its inception from 2014, the motto of Bhima Properties has been to be the brand which people would love to be associated with. Bhima Properties has its head office in Mysuru and has been into the service of providing luxury residential villas and land development of residential plots in Mysuru. Bhima Properties, a part of Shree Mahalakshmi Sweets, Mysuru, promoted by Mr. Shiva Kumar, the two names that has established a formidable track record and quality. Excellent location, quality planning and clear titles are the hallmark for all Bhima Properties, making them an ideal choice of several investors residing in India and abroad who are attracted by a perfect synergy of cost appreciation and ambience.
                                                                "</p>
