                    ...
                    <div class="body">
                        ...
                        <label>Property Type</label>
                            ...
                            <label>Size</label>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Ex: 4000 Sq.Ft">
                                </div>
                            </div>
                            <div class="col-sm-12">
                            <label>Configrations: </label>
                            <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox21" type="checkbox">
                                    <label for="checkbox21">Studio Room</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox22" type="checkbox">
                                    <label for="checkbox22">1BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox23" type="checkbox" checked="">
                                    <label for="checkbox23">1.5BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox24" type="checkbox" checked="">
                                    <label for="checkbox24">2BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox25" type="checkbox">
                                    <label for="checkbox25">2.5BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox26" type="checkbox">
                                    <label for="checkbox26">3BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox27" type="checkbox">
                                    <label for="checkbox27">3.5BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox28" type="checkbox" checked="">
                                    <label for="checkbox28">4BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox29" type="checkbox" checked="">
                                    <label for="checkbox29">4.5BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox30" type="checkbox">
                                    <label for="checkbox30">5BHK</label>
                                </div>
                                <div class="checkbox inlineblock m-r-20">
                                    <input id="checkbox31" type="checkbox">
                                    <label for="checkbox31">5+ BHK</label>
                                </div>
                            ...
                            <label>Age of property(In Years)</label>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Ex: 1,2,3...">
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Bath Rooms">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Bolcany">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                <div class="form-group">
