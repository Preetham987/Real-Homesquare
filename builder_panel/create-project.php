                    ...
                    <section>
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <select class="form-control show-tick" name="builder_name" required>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo '<option value="' . htmlspecialchars($row['builder_name']) . '">' . htmlspecialchars($row['builder_name']) . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control" placeholder="Add Banner Image" name="banner_image" />
                                        </div>
                                    </div>
                            ...
                            <!-- Add More button, initially hidden -->
