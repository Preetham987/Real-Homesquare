                            ...
                            <table class="table td_2 table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>"Exclusive limited-time offer: Book now and unlock special discounts or benefits!"</td>
                                       
                                        <td><a href="edit-social-media-promotion.php"><i class="material-icons" style="color:green">border_color</i></a> <a href=""><i class="material-icons" style="color:red">delete</i></a></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>All </td>
