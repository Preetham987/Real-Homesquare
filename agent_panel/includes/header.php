...
// Query to get the agent_name for the logged-in user
$sql = "SELECT agent_name, address, email_id, phone_number FROM agents_table WHERE username = ?";
...
// Fetch agent name (default to 'Unknown' if not found)
...
<title>Home Square Agent Panel</title>
...
<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dashboard"><i class="zmdi zmdi-home m-r-5"></i>Agent</a></li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Property listing</span></a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="leads-list.php" class="menu-toggle"><i class="zmdi zmdi-case-check"></i><span>Leads</span></a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <p><?php echo htmlspecialchars($email_id); ?></p>
                        <hr>
