...
<nav class="navbar navbar-expand-lg fixed-top navbar-transparent">
    <div class="container">        
        <div class="navbar-translate n_logo">
            <a class="navbar-brand" href="javascript:void(0);" title="" target="_blank">Agents Panel</a>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <span>Designed by <a href="" target="_blank">Rigvesoft</a></span>
            </div>
        </div>
    </footer>
</div>
...
.then(text => {
    ...
    return text ? JSON.parse(text) : {}; // Parse JSON if not empty
})
.then(data => {
    if (data.success) {
