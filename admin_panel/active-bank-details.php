...
$query = "SELECT * FROM customer_bank_details WHERE status = 'Active'";
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            // Display Status
                                            echo '<td>
                                            <button class="status-btn" data-id="' . $row['id'] . '" onclick="toggleStatus(this, ' . $row['id'] . ')" style="background-color: green; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                                                Active
                                            </button>
                                          </td>';                                    
                                            // Actions
