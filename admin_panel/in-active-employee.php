...
<?php
$query = "SELECT * FROM employee_table WHERE status = 'Inactive'";
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <!-- Status Button -->
                                            <td>
                                                <button class="status-btn" data-id="<?php echo $row['id']; ?>" onclick="toggleStatus(this, <?php echo $row['id']; ?>)" style="background-color: <?php echo $statusColor; ?>; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                                                    <?php echo $status; ?>
                                                </button>
                                            </td>
